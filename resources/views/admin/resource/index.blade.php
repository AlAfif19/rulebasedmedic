...
<section class="dm-card overflow-hidden">
    ...
    <form method="GET" class="grid gap-3 border-b border-[#dce5f1] px-5 py-4 lg:grid-cols-[1fr_220px_180px_auto]">
        <div class="flex h-10 items-center gap-2 rounded-[6px] border border-[#c8d4e4] bg-white px-3">
            ...
            <input class="h-full flex-1 bg-transparent text-sm outline-none" type="search" name="q" value="{{ request('q') }}" placeholder="Cari data atau kode">
        </div>
